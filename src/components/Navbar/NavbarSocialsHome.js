...
const NavbarSocialsHome = () => {
  return (
    <div className="flex gap-2 xs:pl-3 md:pl-6">
      <a
        target="_blank"
      ...
      >
        <svg viewBox="0 0 128 128">
          <g fill="">
            <path
              className="fill-current text-gray group-hover:text-white transition duration-200 ease-in-out"
              fill-rule="evenodd"
              clip-rule="evenodd"
      ...
      >
        <svg viewBox="0 0 1024 1024">
          <path
            className="text-gray group-hover:text-white transition duration-200 ease-in-out "
