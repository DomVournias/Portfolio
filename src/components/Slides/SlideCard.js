...
const SlideCard = (props) => {
  return (
    <motion.div
      ...
      className="block w-full justify-around text-left  bg-gray-naive bg-opacity-30 lg:bg-opacity-0 backdrop-filter xs:backdrop-blur-md lg:backdrop-blur-none border-solid border-2 border-white border-opacity-10 lg:border-none "
    >
